    ...
    try {
        if ($status === 'Verified') {
            ...
            $payment_info = $conn->prepare("
                SELECT mp.*, b.movie_name, b.show_date, b.showtime, b.seat_no,
            ...
            $seats = explode(', ', $payment_data['seat_no']);
...
$requests_query .= " ORDER BY mp.created_at DESC";
