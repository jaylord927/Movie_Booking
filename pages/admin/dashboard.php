...
<div class="admin-content" style="max-width: 1400px; margin: 0 auto; padding: 30px;">
    ...
    <div class="admin-stats" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 40px;">
        <div class="stat-card" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); padding: 25px; border-radius: 15px; text-align: center; box-shadow: 0 10px 20px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <div style="color: rgba(255,255,255,0.9); font-size: 1rem;">Active Movies</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); padding: 25px; border-radius: 15px; text-align: center; box-shadow: 0 10px 20px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <div style="color: rgba(255,255,255,0.9); font-size: 1rem;">Active Users</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); padding: 25px; border-radius: 15px; text-align: center; box-shadow: 0 10px 20px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <div style="color: rgba(255,255,255,0.9); font-size: 1rem;">Ongoing Bookings</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); padding: 25px; border-radius: 15px; text-align: center; box-shadow: 0 10px 20px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <div style="color: rgba(255,255,255,0.9); font-size: 1rem;">Active Schedules</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); padding: 25px; border-radius: 15px; text-align: center; box-shadow: 0 10px 20px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <div style="color: rgba(255,255,255,0.9); font-size: 1rem;">Pending Suggestions</div>
        </div>

        <div class="stat-card" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); padding: 25px; border-radius: 15px; text-align: center; box-shadow: 0 10px 20px rgba(0,0,0,0.2); transition: all 0.3s ease; position: relative;">
            <div style="font-size: 2.5rem; color: white; margin-bottom: 10px;">
            ...
            <div style="color: rgba(255,255,255,0.9); font-size: 1rem;">Pending Payments</div>
...
<style>
    .stat-card:hover, .admin-action-btn:hover {
