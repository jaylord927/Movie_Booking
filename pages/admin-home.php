...
// ============================================
// STATISTICS (UPDATED FOR NORMALIZED SCHEMA)
// ============================================
...
// Pending Payments (manual payments waiting for verification)
$pending_payments = 0;
...
<div class="admin-home-container" style="max-width: 1400px; margin: 0 auto; padding: 30px;">
    ...
    <!-- Statistics Cards -->
    <div class="admin-stats" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 25px; margin-bottom: 50px;">
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%); 
            ...
            <div style="color: #ecf0f1; font-size: 1rem;">Paid Bookings</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%); 
            ...
            <div style="color: #ecf0f1; font-size: 1rem;">Upcoming Shows</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%); 
            ...
            <div style="color: #ecf0f1; font-size: 1rem;">Pending Payments</div>
        </div>
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%); 
            ...
            <div style="color: #ecf0f1; font-size: 1rem;">Pending Suggestions</div>
        </div>
    </div>
    ...
    <div class="admin-actions" style="margin-bottom: 50px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
            ...
            <a href="<?php echo SITE_URL; ?>index.php?page=admin/manage-seats" 
               class="admin-action-btn" style="background: linear-gradient(135deg, #9b59b6 0%, #8e44ad 100%); 
                      padding: 25px; border-radius: 12px; text-decoration: none; text-align: center;
                      color: white; font-weight: 600; transition: all 0.3s ease; display: flex;
                      flex-direction: column; align-items: center; gap: 15px;">
            ...
            <a href="<?php echo SITE_URL; ?>index.php?page=admin/manage-schedules" 
               class="admin-action-btn" style="background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); 
                      padding: 25px; border-radius: 12px; text-decoration: none; text-align: center;
                      color: white; font-weight: 600; transition: all 0.3s ease; display: flex;
                      flex-direction: column; align-items: center; gap: 15px;">
            ...
            <a href="<?php echo SITE_URL; ?>index.php?page=admin/manage-users&type=customer" 
               class="admin-action-btn" style="background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); 
                      padding: 25px; border-radius: 12px; text-decoration: none; text-align: center;
                      color: white; font-weight: 600; transition: all 0.3s ease; display: flex;
                      flex-direction: column; align-items: center; gap: 15px;">
            ...
            <a href="<?php echo SITE_URL; ?>index.php?page=admin/manage-payments" 
               class="admin-action-btn" style="background: linear-gradient(135deg, #1abc9c 0%, #16a085 100%); 
                      padding: 25px; border-radius: 12px; text-decoration: none; text-align: center;
                      color: white; font-weight: 600; transition: all 0.3s ease; display: flex;
                      flex-direction: column; align-items: center; gap: 15px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(500px, 1fr)); gap: 30px; margin-bottom: 50px;">
        
        <!-- Recent Movies -->
        <div class="recent-movies" style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 25px;
              border: 1px solid rgba(52, 152, 219, 0.2);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h3 style="color: white; font-size: 1.3rem; font-weight: 700;">
        ...
        <!-- Recent Schedules -->
        <div class="recent-schedules" style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 25px;
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(500px, 1fr)); gap: 30px; margin-bottom: 50px;">
        ...
        <!-- Recent Suggestions -->
        <div class="recent-suggestions" style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 25px;
    ...
    <div style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 25px; margin-bottom: 30px;
          border: 1px solid rgba(52, 152, 219, 0.2);">
        <h3 style="color: white; font-size: 1.3rem; margin-bottom: 20px; font-weight: 700;">
    ...
    <div class="system-info" style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 25px;
          border: 1px solid rgba(52, 152, 219, 0.2);">
        <h3 style="color: white; margin-bottom: 15px; font-size: 1.3rem; font-weight: 700;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.ctrlKey && e.key === '3') {
                e.preventDefault();
                window.location.href = "<?php echo SITE_URL; ?>index.php?page=admin/manage-seats";
            }
